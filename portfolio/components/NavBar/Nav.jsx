    ...
    return (
        ...
        <div className="Nav-main  fixed top-0 w-[100%] z-10">
            <div className=" container mx-auto flex justify-between items-center py-4">
                ...
                <div className="sm:hidden flex gap-6 sm:text-white text-white ">
                    ...
                    <Link href='/Browser' className="hover:underline hover:text-white px-3">
                        Browser
                    </Link>
                ...
                <div className="sm:hidden">
                    <a href="#" className="sm:hidden flex border border-white px-4 py-1 text-white
